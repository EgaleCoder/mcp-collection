...
// Trust the proxy (ngrok, Cloudflare, etc.) so Express sees the correct
...
app.post(MCP_ENDPOINT, async (req: Request, res: Response) => {
  ...
  // ------------------------------------------------------------------
  // (A) Resume an existing session
  // ------------------------------------------------------------------
  if (sessionId && sessions.has(sessionId)) {
    transport = sessions.get(sessionId)!;
  }
  // ------------------------------------------------------------------
  // (B) New session — the body must be an MCP initialize request
  // ------------------------------------------------------------------
